...
public class PointCPTest
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      if(args[0].toUpperCase().charAt(0) == 'C'){
        point = new PointCPD3(Double.valueOf(args[1]).doubleValue(),
                Double.valueOf(args[2]).doubleValue());
      }
      else if(args[0].toUpperCase().charAt(0) == 'P'){
        point = new PointCPD2( Double.valueOf(args[1]).doubleValue(),
                Double.valueOf(args[2]).doubleValue());
      }
      // Throws Exception if argument is not Cartesian or Polar
      else{
   ...
   *         the user.
   */
  private static PointCPD5 getInput() throws IOException
  {
